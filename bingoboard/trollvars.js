const bingoTiles = [
  ...
  },
  {
    ...
    tileDescription:
      'Obtain the Swift Blade from LMS, Post screenshot of LMS points beforehand',
    difficulties: {
      easy: '',
      medium: '',
  ...
  },
  {
    tileCoordinates: 'D8',
    tileName: 'Orb.',
    tileDescription: "Get 10 Awakener's Orbs. Orb. Orb.",
    difficulties: {
      easy: '',
      medium: 'Get 10 orbs',
      hard: '',
  ...
  },
  {
    ...
    tileDescription: 'Obtain a Ring of Eendurance',
    difficulties: {
      easy: '',
      medium: '',
