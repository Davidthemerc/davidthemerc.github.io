...
DSH.Config={
  ...
  seasons:{
    ...
    farmYear:{
      baseCoins:1800,coinPerYear:150,coinScaleCapYears:12,baseGems:5,
      streakCoinBonus:250,streakCap:5,
      masteryThresholds:[3,6,10],masteryFarmCoinPerTier:.02
    },
    definitions:[
  ...
  farmhouse:{
    ...
    trophies:{
      ...
      fullCircle:{icon:'🌎',name:'Full Circle',desc:'Complete all four Season Baskets in one Farm Year.',rewardGems:5},
      steadySeasons:{icon:'🗓️',name:'Steady Seasons',desc:'Complete 3 Farm Years in a row.',rewardGems:7},
      masterSteward:{icon:'🏵️',name:'Master Steward',desc:'Reach Farm Year Mastery Tier III.',rewardGems:10},
      firstMastery:{icon:'🥉',name:'First Mastery',desc:'Earn your first Mastery medal.',rewardGems:2},
      cropMaster:{icon:'🌾',name:'Crop Master',desc:'Reach Gold Mastery with every crop.',rewardGems:8},
      completionist:{icon:'💯',name:'Harvest Completionist',desc:'Reach 100% Harvest Almanac completion.',rewardGems:15}
    },
    tiers:{
  ...
  mastery:{
    tiers:[{key:'bronze',name:'Bronze',icon:'🥉'},{key:'silver',name:'Silver',icon:'🥈'},{key:'gold',name:'Gold',icon:'🥇'}],
    thresholds:{crops:[10,30,75],specials:[10,30,75],powers:[3,10,25],rosie:[10,30,75]},
    rewards:{bronze:{coins:100},silver:{gems:1},gold:{gems:2}},
    sets:{
      crops:{icon:'🌾',name:'Golden Fields',group:'crops',keepsake:{icon:'🌾',name:'Golden Wheat Sheaf'},reward:{coins:1000,gems:5,treats:2}},
      specials:{icon:'🃏',name:'Card Collector',group:'specials',keepsake:{icon:'🃏',name:'Pressed Gold Card'},reward:{coins:1500,gems:10,windmills:1}},
      powers:{icon:'✨',name:'Power Gardener',group:'powers',keepsake:{icon:'🏮',name:'Power Lantern'},reward:{coins:1200,gems:7,gates:1}},
      rosie:{icon:'🐾',name:"Rosie's Best Friend",group:'rosie',keepsake:{icon:'🎀',name:"Rosie's Gold Ribbon"},reward:{coins:1000,gems:6,treats:3,rescues:1}}
    }
  },
  returnRewards:{
    dailyHistory:35,weeklyHistory:8,monthlyHistory:4,
    economyScale:45,
    loyalty:{daysPerRank:7,rankBonus:.10,monthBonus:.25},
    daily:{baseCoins:80,coinStep:20,coinStepCap:3650,baseGems:5},
    weeklyCompletion:{coins:25000,gems:120,treats:5,windmills:3,gates:3,rescues:3},
    monthlyCompletion:{coins:100000,gems:500,treats:18,windmills:8,gates:8,rescues:8},
    makeup:{minLevel:18,levelRange:13,extraStock:4}
  },
  almanac:{
    specials:{
