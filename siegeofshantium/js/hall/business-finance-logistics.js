...
function homeHallEconomyOutlook(){
 ...
 const prisoners=homePrisonerLaborAssigned(),band=homePrisonerLaborProsperityBand(pros),prisonerDay=Math.min(prisoners,homePrisonerLaborCapacity())*band.rate;
